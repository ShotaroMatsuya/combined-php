...
class CrudTest extends TestCase
{
    ...
    public function testItCanCreateReportUsingPostRequest()
    {
        ...
        $response = $this->client->post("http://nginx/src/add.php", $postData);
        $response = json_decode($response, true);
        self::assertEquals(302, $response['statusCode']);
    ...
    public function testItCanUpdateReportUsingPostRequest(BugReport $bugReport)
    {
        ...
        $response = $this->client->post("http://nginx/src/update.php", $postData);
        $response = json_decode($response, true);
        self::assertEquals(302, $response['statusCode']);
    ...
    public function testItCanDeleteReportUsingPostRequest(BugReport $bugReport)
    {
        ...
        $response = $this->client->post("http://nginx/src/delete.php", $postData);
        $response = json_decode($response, true);
        self::assertEquals(302, $response['statusCode']);
